    ...
    <Screen style={styles.screen}>
      <ScrollView style={{ flex: 1, width: "100%" }}>
        <View style={{ justifyContent: "center", alignItems: "center", width: "100%" }}>
          <Text style={{ marginTop: RFPercentage(14), color: Colors.primary, fontSize: RFPercentage(3.5), fontFamily: "VarelaRound_400Regular" }}>Good afternoon Haim,</Text>
          ...
          >
            <View style={{ width: "95%", justifyContent: "center", alignItems: "center", alignSelf: "center" }}>
              <Text style={{ textAlign: "center", color: Colors.white, fontSize: RFPercentage(2.6), fontFamily: "VarelaRound_400Regular" }}>Interested / want to Add Product</Text>
            </View>
          </TouchableOpacity>
          {/* Second */}
          <TouchableOpacity
          ...
          >
            <View style={{ width: "95%", justifyContent: "center", alignItems: "center", alignSelf: "center" }}>
              <Text style={{ textAlign: "center", color: Colors.white, fontSize: RFPercentage(2.6), fontFamily: "VarelaRound_400Regular" }}>Want to Collect</Text>
            </View>
          </TouchableOpacity>
        </View>
