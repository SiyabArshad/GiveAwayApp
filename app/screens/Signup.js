      ...
      <ScrollView style={{ flex: 1, width: "100%" }}>
        <View style={{ justifyContent: "center", alignItems: "center", width: "100%" }}>
          ...
          <TouchableOpacity activeOpacity={0.5} style={{ justifyContent: "center", alignItems: "center" }}>
            <Text style={{ color: "#828282", fontSize: RFPercentage(2), marginTop: RFPercentage(5) }}>Already Have An Account?</Text>
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.5} style={{ justifyContent: "center", alignItems: "center" }} onPress={() => props.navigation.navigate("SignInScreen")}>
            <Text style={{ color: "#828282", fontSize: RFPercentage(2.2), marginTop: RFPercentage(1) }}>Signin</Text>
          </TouchableOpacity>
        </View>
