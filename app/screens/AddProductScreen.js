      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : null} style={{ flex: 1, width: "100%" }}>
        <ScrollView style={{ flex: 1, width: "100%", marginTop: RFPercentage(1) }}>
          <View style={{ justifyContent: "center", alignItems: "center", width: "100%" }}>
            ...
            <View style={{marginVertical:RFPercentage(1),display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"flex-end",width:"100%"}}>
        
               <View style={{display:"flex",flexDirection:"row",alignItems:"center",marginRight:RFPercentage(5)}}>
               <Pressable onPress={()=>{
                settab(0)
                setcond("Good")
               }} 
               style={{backgroundColor:tab===0?Colors.primary:Colors.white,paddingHorizontal:RFPercentage(2),paddingVertical:RFPercentage(1),borderRadius:5,marginRight:RFPercentage(1)}}>
                  <Text style={{color:tab===0?Colors.white:Colors.primary}}>Good</Text>
                </Pressable>
                <Pressable 
                onPress={()=>{
                  settab(1)
                ...
                style={{backgroundColor:tab===1?Colors.primary:Colors.white,paddingHorizontal:RFPercentage(2),paddingVertical:RFPercentage(1),borderRadius:5,marginRight:RFPercentage(1)}}>
                  <Text style={{color:tab===1?Colors.white:Colors.primary}}>Bad</Text>
                </Pressable>
                <Pressable
                onPress={()=>{
                  settab(2)
                ...
                style={{backgroundColor:tab===2?Colors.primary:Colors.white,paddingHorizontal:RFPercentage(2),paddingVertical:RFPercentage(1),borderRadius:5,marginRight:RFPercentage(1)}}>
                  <Text style={{color:tab===2?Colors.white:Colors.primary}}>Excellent</Text>
                </Pressable>
               </View>
            </View>
